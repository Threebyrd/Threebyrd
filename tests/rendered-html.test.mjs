...
test("server-renders the updated ThreeByrd ordering experience", async () => {
  ...
  assert.match(html, /69g/);
  assert.match(html, /114g/);
  assert.match(html, /26g/);
  assert.match(html, /660/);
  assert.match(html, /46\.5g/);
  assert.match(html, /77\.5g/);
  assert.match(html, /17g/);
  assert.match(html, /1113/);
  assert.match(html, /69\.5g/);
  assert.match(html, /113\.5g/);
  assert.match(html, /41g/);
  assert.match(html, /784/);
  assert.match(html, /45\.225g/);
